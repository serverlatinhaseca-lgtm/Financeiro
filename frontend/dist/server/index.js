globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CWz_f7Qf.js","assets/leaflet-src-BbiSgxSs.js","assets/layout-segment-context-DhLrceKY.js"];
...
function getDraftSecret() {
	return "8921b632-98f4-4208-b42d-b3eafb508b5a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5a7bd25a-a086-4276-a8ce-854627fab893";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5a7bd25a-a086-4276-a8ce-854627fab893") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5a7bd25a-a086-4276-a8ce-854627fab893",
		rootBoundaryId
	});
}
/**
...
var __publicFiles = new Set([
	"/brand/assinatura-excelencia.png",
	"/brand/assinatura-yerardo.png",
	"/brand/carimbo-nova-esperanca.png",
	"/brand/excelencia-do-pao-nova.png",
	"/brand/excelencia-do-pao.png",
	"/brand/nova-esperanca-pattern.png",
	"/brand/nova-esperanca-principal.png",
	"/brand/nova-esperanca-vertical.png",
	"/brand/nova-esperanca.jpg",
	"/favicon.svg",
	"/file.svg",
	"/globe.svg",
