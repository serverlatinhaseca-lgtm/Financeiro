globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CLnLEay7.js","assets/leaflet-src-BbiSgxSs.js","assets/layout-segment-context-DLj--6kF.js"];
...
function getDraftSecret() {
	return "fe593695-2cc0-42b4-9bb5-b001ea1461ca";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "0941a670-4eba-471b-87ce-c692394fa9bd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "0941a670-4eba-471b-87ce-c692394fa9bd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "0941a670-4eba-471b-87ce-c692394fa9bd",
		rootBoundaryId
	});
}
/**
