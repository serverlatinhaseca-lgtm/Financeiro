globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CtZ38Aan.js","assets/leaflet-src-BbiSgxSs.js","assets/layout-segment-context-DLKkzuVF.js"];
...
function getDraftSecret() {
	return "6721b1f9-4844-4317-a6c4-8c2e57735104";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "71f2b02d-473e-4ea8-83ab-197940172e83";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "71f2b02d-473e-4ea8-83ab-197940172e83") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "71f2b02d-473e-4ea8-83ab-197940172e83",
		rootBoundaryId
	});
}
/**
