globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CJuaz0yY.js","assets/leaflet-src-BbiSgxSs.js","assets/layout-segment-context-vV3phMIr.js"];
...
function getDraftSecret() {
	return "d64d8a56-a112-4c00-9861-d8404174b1ef";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "590f4982-fd2b-4eac-8b55-9959d8afab5a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "590f4982-fd2b-4eac-8b55-9959d8afab5a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "590f4982-fd2b-4eac-8b55-9959d8afab5a",
		rootBoundaryId
	});
}
/**
